...
class UserController extends Controller
{
    ...
    /**
     * @Route("/{_locale}/admin/website/delete/{id}" , name="delete_website")
     */
    ...
    /**
     * @Route("/{_locale}/admin/websites" , name="admin_websites")
     */
    public function adminWebsites(Request $request)
    {
     ...
     /**
     * @Route("/{_locale}/admin/links/check/status" , name="admin_links_check_status")
     */
    ...
    /**
     * @Route("/{_locale}/admin/links/check" , name="admin_links_check")
     */
    ...
    /**
     * @Route("/{_locale}/admin/files/delete/{id}" , name="delete_file")
     */
    ...
    /**
     * @Route("/{_locale}/admin/files/scrapping" , name="admin_files_scrapping")
     */
    ...
    /**
     * @Route("/{_locale}/admin/files" , name="admin_files")
     */
